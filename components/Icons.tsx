...
export const WandSparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="m15 15 2 2-2 2-2-2 2-2Z" />
    <path d="M6 3.4c-.6.6-.6 1.5 0 2.1l7.8 8c.5.5 1.4.5 2 0l2.3-2.4c.5-.5.5-1.4 0-2l-7.9-8c-.5-.6-1.4-.6-2 0L6 3.4Z" />
    <path d="M9 3l11 11" />
  </svg>
);
...
export const LampIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M10 2h4l3 7H7l3-7Z" />
    <path d="M12 9v13" />
    <path d="M8 22h8" />
  </svg>
);
...
export const RingLightIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const BrushIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2.5 2.24 0 .46.62.8.85 1.12.1.14.24.31.43.51.56.59 1.53 1.17 2.7 1.17 2.37 0 4.3-1.92 4.3-4.29 0-2.21-1.24-3.77-2.78-3.77Z" />
  </svg>
);
...
export const HeartIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19 14c1.49-1.28 3.6-2.36 4.57-4.66C24.48 6.53 22.82 2.76 19.5 2c-3.35-.78-5.75.98-7.5 3.32C10.25 2.98 7.85 1.22 4.5 2 1.18 2.76-.48 6.53 1.43 9.34c.97 2.3 3.08 3.38 4.57 4.66l6 6.35z" />
  </svg>
);
